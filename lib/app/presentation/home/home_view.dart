        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              NavButton(route: Routes.IMAGE_BG, label: 'IMAGE_BG'),
              NavButton(route: Routes.TYPOGRAPHY_COMPARISON, label: 'TYPOGRAPHY_COMPARISON'),
              NavButton(route: Routes.CHECK_THEME, label: 'CHECK_THEME'),
              NavButton(route: Routes.THEME_CHOOSER, label: 'THEME_CHOOSER'),
